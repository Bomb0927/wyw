...
func checkexe2() {
	checkEXE2("C:/bin/mongo.exe")			//读取mongodb的命令行输入exe文件的位置
...
func main() {
	for true {
		...
		fmt.Println("please choose the features which do you want to use,select_client enter 1, get random assets enter 2, exit enter 0")
		var choice int
		fmt.Scan(&choice)
		if choice == 0{
			break
